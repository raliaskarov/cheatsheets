...
|tar -czvf models.tar.gz models|add folder "models" to archive. -c — create a new archive; -z — compress to .gz; -v — verbos; -f — the next argument is the filename|
|tar -xzvf models.tar.gz| extract|
